...
import { PL3_LOTTERY_TYPE, PL3_MCP_TOOLS, McpApiError, createLotteryMcpClient, createPl3PredictionService, formatMcpApiError, } from 'lotterymcp-core';
import { z } from 'zod';
...
const parsePl3LotteryType = (value) => {
    if (value === undefined)
        return undefined;
    if (value === PL3_LOTTERY_TYPE)
    ...
    return [
        {
            ...
            handler: async (args) => withToolExecution(() => client.getLatest({ lotteryType: parsePl3LotteryType(args.lotteryType) })),
        },
        {
